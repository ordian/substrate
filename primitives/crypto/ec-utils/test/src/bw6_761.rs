...
#[test]
fn test_bw6_761_g1_mul_projective_runtime() {
...
#[test]
fn test_bw6_761_g2_mul_projective_runtime() {
	use ark_bw6_761::G2Projective;
	// Get runtime client for testing
	let test_client = get_test_client().expect("Test client builds");
...
#[test]
fn test_bw6_761_multi_miller_loop_runtime() {
	// Get runtime client for testing
	let test_client = get_test_client().expect("Test client builds");
...
#[test]
fn test_bw6_761_final_exponentiation_runtime() {
	use ark_bw6_761::G1Projective;
	...
	let result = test_client
		.runtime_api()
		.test_bw6_761_final_exponentiation(
			test_client.chain_info().genesis_hash,
			base.encode(),
			scalar.encode(),
		)
